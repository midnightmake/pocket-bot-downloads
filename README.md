...
* `courses`: Various line and demo courses as seen in the [example programs](https://www.midnightmake.com/pages/pocket-bot-example-programs). Courses are provided as both `.docx` and `.pdf` files.
